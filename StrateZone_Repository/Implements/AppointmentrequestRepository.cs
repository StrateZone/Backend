    ...
    public class AppointmentrequestRepository : IAppointmentrequestRepository
    {
        ...
        public async Task<Appointmentrequest> AcceptAppointmentrequestAsync(int id)
        {
            ...
            try
            {
                ...
                FOR UPDATE",
                        toAccept.AppointmentId, toAccept.TableId, 
                        DateTime.SpecifyKind((DateTime)toAccept.StartTime, DateTimeKind.Utc), 
                        DateTime.SpecifyKind((DateTime)toAccept.EndTime, DateTimeKind.Utc), 
                        toAccept.FromUser
                        )
                    .ToListAsync();
        ...
        public async Task CancelAllSentRequestsFromTablesAppointmentIdAsync(int tablesAppointmentId)
        {
            ...
            await _context.Database.ExecuteSqlRawAsync(
                ...
                ta.AppointmentId, 
                ta.TableId, 
                DateTime.SpecifyKind(ta.ScheduleTime, DateTimeKind.Utc), 
                DateTime.SpecifyKind(ta.EndTime, DateTimeKind.Utc)
            );
        }
