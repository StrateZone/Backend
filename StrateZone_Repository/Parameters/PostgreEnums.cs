namespace StrateZone_Repository.Parameters
{
    ...
    {
        public enum AppointmentStatus { pending, confirmed, cancelled, completed, expired, unpaid, refunded, checked_in, imcompleted, incoming, incompleted, unfinished }
        ...
        public enum NotificationType { appointment, order, tables_appointment, appointment_request_from, appointment_request_to, thread, friend, friend_request, community, tables_appointment_invitations_timedout }
        ...
        public enum ThreadStatus { published, rejected, pending, deleted, drafted, hidden }
