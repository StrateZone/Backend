...
{
    public enum RefundStatus { cancellation_fail, no_refund, no_refund_while_refund_for_invited_user, refund_partial_percentage_of_total, refund_100_percentage_of_total };
