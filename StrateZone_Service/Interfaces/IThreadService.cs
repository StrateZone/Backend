...
namespace StrateZone_Service.Interfaces
{
    public interface IThreadService
    {
        ...
        Task<PagedList<ThreadModel>> GetAllThreadsAsync(ThreadParameters parameters);
        ...
        Task<ThreadModel> EditThreadAsync(ThreadEditRequest thread, int id);
        ...
        Task<int> GetAllThreadsWithinAMonthInYearAsync(int month, int year);
    }
}
